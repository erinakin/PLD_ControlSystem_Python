...
class PressureControls:
    ...
    def __init__(self, port='COM11', baudrate=9600, timeout=10):
        """
    ...
    def read_response(self):
        """
        Read the response from the pressure controller.

        Args:
            response (str): The response from the pressure controller.
    ...
    # def request_analog_setpoint_value(self):
    #     """
    #     Request the analog set point value.

    #     Returns:
    #     str: The response from the controller.
    #     """
    #     request = self.send_command("R0")
    #     return self.read_response()
    
    # def request_setpoint_value(self, point):
    #     """
    #     Request the set point value.

    #     Parameters:
    #     point (str): The set point (A, B, C, D).
    ...
    #     if point in points:
    #         request = self.send_command(f"R{points[point]}")
    #         return self.read_response()
    #     else:
    #         raise ValueError("Invalid set point. Choose from A, B, C, D.")
