...
tic.settings.load_config(r'C:\Users\m3learning\Documents\PLD_ControlSystem_Python\PLD_ControlSystem_Python\src\pld_controlsystem_python\pytic\config\config.yml')
tic.settings.apply()                             
