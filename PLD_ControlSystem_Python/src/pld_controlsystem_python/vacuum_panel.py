...
com_port_selector = pn.widgets.Select(name='', options=available_ports, value=correct_port if correct_port else (available_ports[0] if available_ports else 'COM6'))
